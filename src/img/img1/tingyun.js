var TINGYUN = function (t, e, n) {
    ...
    function K(t) {
        ...
        if (t) {
            ...
            var u = r(gn), s = r(mn), c = r(yn), f = r(bn), l = r(Sn), d = r(xn);
    ...
    var Rt, Nt, qt = o("String"), Ot = o("Array"), At = o("Function"), Lt = o("Object"), Ht = o("Undefined"), Bt = '"',
        Mt = /([\"\\])/g, jt = /\n/g, zt = e.JSON;
    ...
    var Zt = w("ignore_err"), te = w("debug"), ee = e.location, ne = e.navigator, re = e.HTMLElement, ie = function () {
        try {
            var t = Wt();
    ...
    var He = {
            pvid: Wt(), ref: $t.URL, referrer: $t.referrer, key: Vt.key, v: "1.7.5", av: "1.7.5", did: function () {
                var t = ae(ge);
        ...
        }, Me = "{0} not support", je = "illegal argument", ze = {}, De = "undefined" != typeof e.console, Fe = 1, Pe = 2,
        Ue = 4, Ye = 8, Xe = M.prototype;
    ...
    var nn = 0, rn = "fetchStart", on = "requestStart", an = "responseStart", un = "responseEnd",
        sn = "domContentLoadedEventStart", cn = "domContentLoadedEventEnd", fn = "domInteractive", ln = "domComplete",
        dn = "loadEventStart", hn = "loadEventEnd", pn = "unloadEventStart", vn = "unloadEventEnd",
        gn = "domainLookupStart", mn = "domainLookupEnd", yn = "redirectStart", bn = "redirectEnd", Sn = "connectStart",
        xn = "connectEnd", _n = "secureConnectionStart", wn = function (t) {
            if (!t.agent) {
                var n = e._ty_rum;
    ...
    var En = function () {
        var t = y(function () {
            ...
            o || L(p(Me, ["pf"]));
            var a = Z(wn), u = r && r.timing, s = d(K(u), a, Ie), c = d({}, Ve);
