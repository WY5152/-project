...
loadScript( LKconfig.WebURL + "/swfobject.js");
loadScript( LKconfig.WebURL + "/web_socket.js");
...
loadScript( LKconfig.WebURL + "/Scripts/" + LKId + ".js",function(){
	loadScript( LKconfig.MUrls + "/Scripts/m/Utils.js",function(){
		loadScript( LKconfig.MUrls + "/Scripts/Template.js",function(){
			
			if (LKconfig.WebSiteId == "lq") {
    loadScript(LKconfig.WebURL + "/Scripts/m/Tell.js");
}
...
openkfWin=function openkfWin(i) {
    if (i < 3) { //接受邀请
        try {
            CloseWs(3);
            var vote = "";
